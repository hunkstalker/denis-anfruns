...
TODO: Añadir código del panel y del botón de tema.

Ignorad el slide y el fondo de puntos, esta captura y la de la cabecera es de la versión en el momento de escribir este artículo, así que ya os he hecho un pequeño spoiler 😁

![image](/assets/stardraw/panel-herramientas.png)

Nada más empezar lo que más me impresionó al inicio es todo lo que cubre `react-konva`. Facilita mucho el desarrollo de las herramientas que necesito para el proyecto. Os enlazo a su documentación para que podáis ver todo lo que ofrece: <span class='text-[--tangerine]'>https://konvajs.org/docs/react/index.html</span>.

- Dibujo libre
- Dibujo de formas
- Soltar o pegar imágenes sobre el canvas
- Drag & Drop para mover elementos
- Transformaciones y rotaciones

Así que ya tenía la estructura de carpetas definida, dependencias instaladas y un canvas con un panel de herramientas en el que había un botón funcional que cambiaba entre el modo claro y oscuro.