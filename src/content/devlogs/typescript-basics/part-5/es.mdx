...
En la **Parte 6** lo pondremos en juego con los **Type Guards & Narrowing**: veremos cómo usar `typeof` e `instanceof` dentro del cuerpo de una función para estrechar el tipo y saber exactamente qué recibimos.
