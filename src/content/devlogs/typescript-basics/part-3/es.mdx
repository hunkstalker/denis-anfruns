...
<Callout type="party" title="¡Ey!">
    <p>Probemos a activar el volumen del editor antes de darle al botón > Run cuando vayamos a resolver el ejercicio!</p>
</Callout>
...
<TSEditor
  ...
  files={{
    'main.ts': `// 1. Definamos nuestra interface 'Videojuego' aquí
