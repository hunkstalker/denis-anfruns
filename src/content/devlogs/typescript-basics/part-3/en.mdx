...
Let's put what you've learned to the test. Define an interface and create a specific object that complies with the requirements below.
...
```ts
// 1. Define your 'VideoGame' interface here
// interface VideoGame ...
