...
draft: false
new: true
title: 'TypeScript #12: Inferencia Avanzada (infer)'
...
<Callout type="tip" title='"Funciones de Tipos"'>
	Si lo has pensado, estás en lo cierto: **Estás programando con tipos.**

	*   `EsString<T>` es la **función** (y `T` el parámetro).
...
En la **Parte 13** (y final), pondremos todo junto. Veremos patrones de diseño reales, sobrecarga de funciones y cómo crear tu propia mini-librería "Type-Safe".
