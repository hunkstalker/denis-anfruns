...
A la **Part 10**, abordarem una de les confusions més grans: **Generics en Interfícies vs en Tipus**, i com passar tipus de pares a fills (prop drilling de tipus).
