...
const simple: RespuestaAPI = { data: "Todo ok", status: 200 }; // T es string

// Uso especificando tipo
const compleja: RespuestaAPI<number> = { data: 123, status: 200 }; // T es number`,
		lang: 'typescript'
    }
]} />
...
En la **Parte 10**, abordaremos una de las mayores confusiones: **Generics en Interfaces vs en Tipos**, y cómo pasar tipos de padres a hijos (prop drilling de tipos).
