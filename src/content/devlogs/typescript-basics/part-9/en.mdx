...
```ts
// Challenge: Modify 'merge' to ONLY accept real objects.
...
// ✅ Success case (this will always work):
const result = merge(user, settings); 
console.log("Result:", result);

// 🧪 Check. This is what we want to avoid, letting a number slip through.
...
In **Part 10**, we'll address one of the biggest confusions: **Generics in Interfaces vs in Types**, and how to pass types from parents to children (prop drilling of types).
