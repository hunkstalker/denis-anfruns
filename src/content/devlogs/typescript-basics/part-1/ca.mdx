...
Molts devs que venen de llenguatges fortament tipats (com C, Java o C# antics) és normal que estiguem acostumats a la idea de tipar-ho tot.
...
Des del nostre punt de vista, deixaríem que TS infereixi any (o el posaríem nosaltres mateixos) en casos en què no sabem el que passarà, sigui per errors o que la resposta pugui ser molt àmplia.
...
A la **Part 2**, mirarem com usar aquests tipus literals al nostre favor amb les **Unions**, i com dir-li a TS: _"Aquesta variable només pot ser 'admin' o 'user', res més"_.

## Experimenta!

Aquí tens el punt de partida. Copia el codi i prova'l a <a href="https://www.typescriptlang.org/play" target="_blank" rel="noopener noreferrer">TypeScript Playground oficial</a>:
