...
- **Menos es más**: Si TS puede inferirlo, no lo escribamos. Tu código será más limpio.
- **Variable (`let`)** = Tipo General (`string`, `number`).
- **Constante (`const`)** = Tipo Literal (El valor exacto).

En la **Parte 2**, miraremos cómo usar esos tipos literales a nuestro favor con las **Uniones**, y cómo decirle a TS: _"Esta variable solo puede ser 'admin' o 'user', nada más"_.

## ¡Experimentemos!

Aquí tienes el punto de partida. Copia el código y pruébalo en <a href="https://www.typescriptlang.org/play" target="_blank" rel="noopener noreferrer">TypeScript Playground oficial</a>:
