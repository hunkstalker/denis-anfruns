...
Embrutem-nos les mans. Tens dos reptes a sota: un per Arrays i un altre per Tuples. Prova les solucions al [TypeScript Playground oficial](https://www.typescriptlang.org/play) per veure els errors.
