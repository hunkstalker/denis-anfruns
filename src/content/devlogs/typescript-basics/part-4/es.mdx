...
Vamos a ensuciarnos las manos. Tienes dos retos abajo: uno para Arrays y otro para Tuplas. Prueba las soluciones en <a href="https://www.typescriptlang.org/play" target="_blank" rel="noopener noreferrer">TypeScript Playground oficial</a> para ver los errores.
...
```ts
// 1. Crea un array de strings llamado 'paises'
// const paises...
...
```ts
// Crea la tupla 'usuario' con tipo [string, number, boolean]
// const usuario...
```
