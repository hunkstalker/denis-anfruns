...
Vamos a ensuciarnos las manos. Tienes dos retos abajo: uno para Arrays y otro para Tuplas. Prueba las soluciones en el [TypeScript Playground oficial](https://www.typescriptlang.org/play) para ver los errores.
