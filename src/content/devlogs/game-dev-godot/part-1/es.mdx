...
**¿Pero qué es "move_right"?**
Si intentas ejecutar el código ahora, **no funcionará**. Godot no sabe qué teclas son esas. Tienes que configurarlas tú para definir qué significa "mover a la derecha" (puede ser la tecla D, la Flecha Derecha o el Joystick).
