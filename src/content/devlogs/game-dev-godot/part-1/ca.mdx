...
**Però què és "move_right"?**
Si intentes executar el codi ara, **no funcionarà**. Godot no sap quines tecles són aquestes. Has de configurar-les tu per definir què significa "moure a la dreta" (pot ser la tecla D, la Fletxa Dreta o el Joystick).
...
Aquí entra el senyor Pitàgores amb el seu famós **Teorema**. No t'espantis, anem a disseccionar-lo peça a peça:
...
Anem a substituir les lletres per els nostres números (1 dreta, 1 avall):
...
Anem a col·locar-la al centre exacte usant lògica:
...
<Callout type="tip" title="La meva nau marxa de la pantalla?">
  ...
  En propers capítols posarem murs a aquest univers.
</Callout>
