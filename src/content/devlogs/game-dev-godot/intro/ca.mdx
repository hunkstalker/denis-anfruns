...
Si estàs aquí, és perquè vols fer videojocs. Però no vols simplement copiar codi d'un tutorial de YouTube i resar perquè funcioni. Vols **entendre** què està passant sota el capó.

En aquesta sèrie, no crearem experiments solts. Construirem **UN joc complet de principi a fi**: **"Space Survivor"** 🚀.
