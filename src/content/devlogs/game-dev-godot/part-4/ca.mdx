...
Només AQUESTA funció (`hit_flash`) està "dormint" esperant. Quan el timer acaba, la funció es "desperta" i continua des d'on es va quedar (desactivar el flash).

És com posar un recordatori al mòbil: "En 0.1 segons, apaga el flash". Mentrestant, segueixes amb la teva vida.
