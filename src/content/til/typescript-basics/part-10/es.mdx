...
Imagina que quieres saber qué devuelve una función, pero no tienes acceso a su código fuente, solo al tipo de la función.
...
Imagina que tienes una `Promise<User>`, pero quieres obtener el tipo `User` directamente.
...
Crea un tipo `UnpackArray<T>` que extraiga el tipo de un array.
