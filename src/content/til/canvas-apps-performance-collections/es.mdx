...
<Callout type="warning" title="Cuidado con el volumen" filled>
	No intentes cargar tablas de 50.000 filas en una colección móvil. Limítate a datos maestros o de
	configuración. Para grandes volúmenes, sigue usando delegación directa.
</Callout>
