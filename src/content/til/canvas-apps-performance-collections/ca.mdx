...
<Callout type="warning" title="Compte amb el volum" filled>
	No intentis carregar taules de 50.000 files en una col·lecció mòbil. Limita't a dades mestres o de
	configuració. Per a grans volums, continua utilitzant delegació directa.
</Callout>
