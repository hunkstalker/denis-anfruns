...
export default function TilCard({ post, lang, labels }: Props) {
	...
	return (
		<article className="til-card group relative flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-4 shadow-sm transition-shadow duration-300 hover:border-black/15 hover:shadow-md dark:border-zinc-700/50 dark:bg-zinc-800 dark:hover:border-white/15 sm:rounded-2xl sm:p-6 h-full">
