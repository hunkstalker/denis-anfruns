				...
				<div className="pointer-events-none absolute -bottom-8 -right-12 z-0">
					{decorativeIcons.map((svg, index) => {
						...
						return (
							<div
								key={index}
								className="icon-fan absolute size-44 opacity-[0.30] transition-all duration-500 ease-out group-hover:scale-110 group-hover:opacity-50 dark:opacity-[0.30] dark:group-hover:opacity-[0.50] [&_svg]:size-full"
								style={
									{
