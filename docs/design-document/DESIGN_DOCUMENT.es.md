...
- **Diseño Mágico (Magic Layout)**:
    - Al filtrar o reordenar, los elementos deben *deslizarse* a sus nuevas posiciones, no saltar. Usa la propiedad `layout` de `framer-motion`.
...
---
*Adhiérete a estas reglas para todos los componentes futuros para mantener la integridad del diseño del sitio.*
