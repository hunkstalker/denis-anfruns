...
- **Magic Layout**:
    - When filtering or reordering, items should *drift* to their new positions, not jump. Use `framer-motion`'s `layout` prop.
...
---
*Adhere to these rules for all future components to maintain the site's design integrity.*
